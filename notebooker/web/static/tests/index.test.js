...
describe("index.js", () => {
  beforeEach(() => {
    ...
    $("body").html(
      '<div id="folderNavigationPanel"></div><div id="cardContainer"></div>'
    );
    fetch.mockClear();
  });
  ...
  test("updateNavigationPanel", () => {
    console.log(updateNavigationPanel);
  ...
  test("load_data", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith(
      "/core/get_all_templates_with_results/folder/test/my fake folder/hello/"
    );
